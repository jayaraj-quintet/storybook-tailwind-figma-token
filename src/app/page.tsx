...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-fill-gray-faint p-2xl">
      <div className="text-center mb-3xl">
        <h1 className="text-fs-4xl font-bold text-text-default mb-md">
          Button Component
        </h1>
        <p className="text-fs-xl text-text-default-lighter">
      ...
      <section className="w-full max-w-6xl mb-3xl">
        <h2 className="text-fs-2xl font-semibold text-text-default mb-lg">Sizes</h2>

        <div className="bg-fill-white p-xl rounded-lg border border-stroke-gray-light flex gap-20">
